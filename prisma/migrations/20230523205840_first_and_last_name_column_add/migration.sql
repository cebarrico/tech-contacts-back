/*
  ...
  - Added the required column `main_email` to the `contacts` table without a default value. This is not possible if the table is not empty.
  - Added the required column `main_phones` to the `contacts` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "main_email" TEXT NOT NULL,
ADD COLUMN     "main_phones" TEXT NOT NULL;
